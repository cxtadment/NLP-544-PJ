...
def readWeibo():								
	...
	annotation_file=open('/Users/sx/Desktop/CSCI544/FinalProject/Weibo/Dataset/fuzhou/SIGHAN8-Task2-Corpus/Annotation.txt', 'r')
	pos_list=[]
	neg_list=[]
	neu_list=[]
	...
	neu_results=[]
	weibo_dict={}
	message_file=codecs.open('/Users/sx/Desktop/CSCI544/FinalProject/Weibo/Dataset/fuzhou/SIGHAN8-Task2-Corpus/Message.txt','r','utf-8')
	count=0
